...
public class MergeTwoSortedArrays {
    ...
    public static void main(String[] args) {
        // When you say core.sorting, it's ascending or descending order
        ...
        // what could be the min and max size of the each core.array.
    ...
    public static int[] mergeTwoSortedArray(int[] arr1, int len1, int[] arr2, int len2) {
        ...
        while (i < len1 && j < len2) {
            //checking if Current element of first core.array is less than second core.array
            //If yes store it in 3rd core.array
            if (arr1[i] < arr2[j]) {
                merge[k] = arr1[i++];
                k++;
            } else {
...
//Store remaining elements of first core.array to arr3
        while (i < len1) {
            merge[k] = arr1[i++];
        }
//Store reaming elements of 2nd core.array to arr2
        while (j != len2) {
            merge[k] = arr2[j++];
        }
        return merge;

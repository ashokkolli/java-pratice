...
public class SumTwoLargeNumbers {
    ...
    public static void main(String[] args) {
        String str1 = "12";
        String str2 = "198111";
        System.out.println(sumTwoLargeNumbers_BT(str1, str2));
    ...
    public static String sumTwoLargeNumbers(String str1, String str2){
        ...
        int i = 0;
        while(len1 >= 0 || len2 >= 0 ){
            int x = len1 >= 0 ? str1.charAt(len1) - '0' : 0;
            int y = len2 >= 0 ? str2.charAt(len1) - '0' : 0;
            int  sum =  x + y + carry;
            carry = sum/10;
            int value = sum%10;
            sb.append(value);
...
//        }
    ...
    public static String sumTwoLargeNumbers_BT(String str1, String str2){
        //1. find length of two stings
        //2. find Sum and carry
        //3. add Sum to output string
        //4. Add remaining digits's Sum and carry and add sum to output sting
